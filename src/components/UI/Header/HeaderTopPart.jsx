      ...
      <div className="header-top">
        ...
        <div className="setting-box-container">
          <div
            ...
            data-target="#settings-toggle"
            className="setting-icon"
          >
            <i className="fas fa-cog" />
          </div>
          <div id="settings-toggle" className="collapse setting-box">
            <div>
              <h4>Theme</h4>
              <div id="select-theme" className="collapse show setting-sub-box">
                <div className="switch-theme">
                  <div className="selected">
                    <span>Dark</span> <i className="fas fa-moon ml-2" />
                  </div>
                  <div className>
                    <span>Light</span> <i className="fas fa-sun ml-2" />
                  </div>
                </div>
              </div>
            </div>
            <div>
              ...
              <div
                id="select-language"
                className="collapse show setting-sub-box"
              >
                <div className="language-list">
                  <div className>हिंदी</div>
                  <div className="selected">English</div>
                  <div className>मराठी</div>
                  <div className>ગુજરાતી</div>
                  <div className>தமிழ்</div>
                </div>
              </div>
            </div>
          </div>
